...
export default function TeaAttributes({ product }: { product: Product }) {
  return (
    <div className="space-y-6 rounded-2xl bg-cream p-6 text-ink">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-ink/60">Tasting Notes</p>
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-ink/60">Brew Guide</p>
          <ul className="mt-2 text-sm text-ink/80">
